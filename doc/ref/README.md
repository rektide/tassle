...
Tass's own lexicons live in the `tass-lex-schema` crate at [`crates/tass-lex-schema/lexicons/`](../../crates/tass-lex-schema/lexicons/):

- [`crates/tass-lex-schema/lexicons/com.superbfowle.tass.node.json`](../../crates/tass-lex-schema/lexicons/com.superbfowle.tass.node.json)
- [`crates/tass-lex-schema/lexicons/com.superbfowle.tass.form.json`](../../crates/tass-lex-schema/lexicons/com.superbfowle.tass.form.json)
- [`crates/tass-lex-schema/lexicons/com.superbfowle.tass.resonance.json`](../../crates/tass-lex-schema/lexicons/com.superbfowle.tass.resonance.json)
- [`crates/tass-lex-schema/lexicons/com.superbfowle.tass.enervate.json`](../../crates/tass-lex-schema/lexicons/com.superbfowle.tass.enervate.json)
- [`crates/tass-lex-schema/lexicons/com.superbfowle.tass.meditate.json`](../../crates/tass-lex-schema/lexicons/com.superbfowle.tass.meditate.json)
- [`crates/tass-lex-schema/lexicons/com.superbfowle.tass.tassilize.json`](../../crates/tass-lex-schema/lexicons/com.superbfowle.tass.tassilize.json)
