...
Tassle's current resonance lexicon ([`crates/tass-lex-schema/lexicons/com.superbfowle.tass.resonance.json`](../../crates/tass-lex-schema/lexicons/com.superbfowle.tass.resonance.json)) is — read charitably — a degenerate `pub.layers.ontology` instance with one collection and one typeDef kind. Specifically:
...
- [`crates/tass-lex-schema/lexicons/com.superbfowle.tass.resonance.json`](../../crates/tass-lex-schema/lexicons/com.superbfowle.tass.resonance.json) — tassle's current resonance schema
...
- [`crates/tass-lex-schema/lexicons/com.superbfowle.tass.resonance.json`](../../crates/tass-lex-schema/lexicons/com.superbfowle.tass.resonance.json) — tassle's existing lexicon that uses `defs.main` plus named sub-defs (`resonanceValue`, `resonanceProfile`)
